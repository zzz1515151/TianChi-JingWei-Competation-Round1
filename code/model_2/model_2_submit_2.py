...
class Test_dataset(Dataset):
	def __init__(self, unit_size):
		...
		self.img_dir = '../../data/jingwei_round1_test_a_20190619/image_4.png'
...
# resume
# 修改为保存模型参数文件的路径
resume_path = '../../data/train_model_2/checkpoint.pth.tar'
...
if not os.path.exists("../../submit/result_model_2"):
	os.mkdir("../../submit/result_model_2")
pred_out_.save("../../submit/result_model_2/image_4_predict.png", "PNG")
